...
exports.registro_descuento_admin = async (req, res) => {
    if(req.user) {
...
exports.listar_descuentos_admin = async(req, res) => {
    if(req.user) {
        if (req.user.role='admin') {
...
exports.obtener_banner_descuento = async(req,res) => {
...
exports.obtener_descuento_admin = async (req,res) => {
    if (req.user) {
     if (req.user.role == 'admin') {
...
exports.actualizar_descuento_admin = async (req, res) => {
    if(req.user) {
        if (req.user.role='admin') {
...
exports.eliminar_descuento_admin = async (req,res) => {
    if (req.user) {
        if (req.user.role == 'admin') {
...
exports.obtener_descuento_activo = async (req,res) => {
